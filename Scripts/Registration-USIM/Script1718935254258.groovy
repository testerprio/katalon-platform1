...
CustomKeywords.'OtherKeyword.selectObjectBasedOnIndex'(findTestObject('div contains', [('attr') : '@class', ('val') : 'cursor-pointer']), 
    '1')

CustomKeywords.'SupportMethod.selectRandomlyListobject'(findTestObject('div contains', [('attr') : '@class', ('val') : 'location-list']))

WebUI.click(findTestObject('btn contains', [('attr') : '@class', ('val') : 'btn-primary    mt']))
